...
{ "地灵殿L(梦A,简化)",
    { "一面", "二前半", "帕露西道中非", "嫉妒「看不见的绿眼怪兽」", "二后半", "帕露西一非", "开花爷爷「小白的灰烬」", "帕露西二非", "剪舌麻雀「大葛笼与小葛笼」", "恨符「丑时参拜第七日」",
        ...
        "六前半", "妖怪「火焰的车轮」","六后半","阿空一非", "核热「核反应失控」", "阿空二非", "爆符「千兆耀斑」", "阿空三非","焰星「十凶星」","阿空四非","「地狱的托卡马克装置」","「地底太阳」",
   }
},
{ "地灵殿L(梦B,简化)",
    { "一面", "二前半", "帕露西道中非", "嫉妒「看不见的绿眼怪兽」", "二后半", "帕露西一非", "开花爷爷「小白的灰烬」", "帕露西二非", "剪舌麻雀「大葛笼与小葛笼」", "恨符「丑时参拜第七日」",
...
{ "锦上京L（简化）",
    { "一前半", "一道中非", "一后半", "姥芽一非", "尘符「宇宙尘埃」", "姥芽二非", "尘符「唐柜大翻转」", "尘符「尘埃栖所」", "二前半", "二道中非", "二后半", "魑魅一非",
     "魅符「狂野山涧之气」", "魑魅二非", "魅符「窒息森林之气」", "魑符「暴怒山岳之气」", "三前半", "三前半大蝴蝶", "三后半", "三后半大蝴蝶", "驯子一非", "谜符「六角迷宫」",
    "驯子二非", "塞符「逻辑长城」", "驯子三非", "谜符「远古陷阱」", "金符「弹幕金字塔」", "四前半前", "DNA阵", "四前半后", "四道中一非", "四道中二非", "四后半", "浅间一非",
    "虚符「推流提线木偶」", "浅间二非", "群符「碎片大数据」", "浅间三非", "「只消醉心射鹿的美好记忆」", "虚构「无效交流」", "五开", "五前半", "蛆窝", "大金字塔", "五后半", "鬼火阵",
    "丰姬一非", "宝珠「潮盈珠」", "丰姬二非", "灾祸「无尽的山洪」", "丰姬三非", "宝珠「潮干珠」", "「月龙」", "六前半", "六前半鬼火", "六后半", "阿梨夜一非", "石神「汇作巨岩的碎石」",
    "阿梨夜二非", "死符「恒久之冬」", "阿梨夜三非", "生符「混沌之冬」", "阿梨夜四非", "「弹幕的化石」", "阿梨夜五非", "地符「幻想的遗骸」", "月符「锦上的虚像」", "「不生不灭的石之女神」"}
 },
    };
...
{ "錦上京L",
    { "1面道中 前半", "1面道中 中ボス", "1面道中 後半", "ウバメ 通常1", "塵符「宇宙塵」", "ウバメ 通常2", "塵符「唐櫃大返し」", "塵符「塵のすみか」", "2面道中 前半", "2面道中 中ボス", "2面道中 後半", "チミ 通常1",
     "魅符「荒くれる沢の気」", "チミ 通常2", "魅符「息苦しい森の気」", "魑符「怒れる山の気」", "3面道中 前半", "3面道中 妖精地帯(前半)", "3面道中 後半", "3面道中 妖精地帯(後半)", "馴子 通常1", "謎符「ヘキサゴナルラビリンス」",
    "馴子 通常2", "塞符「ロジカルグレートウォール」", "馴子 通常3", "謎符「エンシャントトラップ」", "金符「弾幕の金字塔」", "4面道中 前半#1", "DNA地帯", "4面道中 前半#2", "4面道中 中ボス 通常1", "4面道中 中ボス 通常2", "4面道中 後半", "ユイマン 通常1",
    "虚符「ストリーミングマリオネット」", "ユイマン 通常2", "群符「ラブルビッグデータ」", "ユイマン 通常3", "「シカを射るだけの美しい記憶」", "虚構「ディスコミュニケーション」", "5面道中 開幕", "5面道中 前半", "5面道中 黒妖精地帯", "大ピラミッド", "5面道中 後半", "5面道中 怨霊地帯",
    "豊姫 通常1", "宝珠「潮盈珠」", "豊姫 通常2", "災禍「終わらない山津波」", "豊姫 通常3", "宝珠「潮乾珠」", "「ムーンドラゴン」", "6面道中 前半", "6面道中 怨霊地帯", "6面道中 後半", "阿梨夜 通常1", "石神「巌となるさざれ石」",
    "阿梨夜 通常2", "死符「恒久の冬」", "阿梨夜 通常3", "生符「混沌の冬」", "阿梨夜 通常4", "「弾幕の化石」", "阿梨夜 通常5", "地符「幻想のリリクウィー」", "月符「錦の上のイマジナリー」", "「不生不滅の石の女神」"}
 },
    };
    ...
    public:
        ...
        void GuiGetDetails()
        {
            ...
            if (GuiModal(S(THPRAC_KENG_DETAILS_POPUP), { LauncherWndGetSize().x * 0.95f, LauncherWndGetSize().y * 0.8f }, &isopen)) {
                ...
                ImGui::SameLine();
                HelpMarker(S(THPRAC_KENG_DETAILS_CAL_EM_DESC));
                ImGui::SetCursorPosX(ImGui::GetWindowWidth() * 0.05f);
